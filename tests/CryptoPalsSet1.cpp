...
TEST_F (CryptoPalsSet1, Challenge7) {
    ...
    char *decrypted_bytes = static_cast<char *>(calloc(sizeof(char), raw_bytes_size + EVP_MAX_BLOCK_LENGTH));
    ...
    ASSERT_EQ(1, EVP_CIPHER_CTX_reset(ctx));
    ASSERT_EQ(1, EVP_CipherInit_ex(ctx, EVP_aes_128_ecb(), nullptr, key, nullptr,
                             0));
    ASSERT_EQ(1, EVP_CipherInit_ex(ctx, nullptr, nullptr, key, nullptr, 0));
    ASSERT_EQ(1, EVP_CipherUpdate(ctx,
